...
public class EditControl : Control, IImeSupport, IEditorViewMetrics
{
    ...
    private static string GetOneSyntaxBrushKey(TokenClassification classification)
    {
        return classification switch
        {
            ...
            TokenClassification.StructName => "OneEditorSyntaxStructName",
            TokenClassification.EnumName => "OneEditorSyntaxEnumName",
            TokenClassification.InterfaceName => "OneEditorSyntaxInterfaceName",
            TokenClassification.DelegateName => "OneEditorSyntaxDelegateName",
            ...
            TokenClassification.EnumMember => "OneEditorSyntaxEnumMember",
