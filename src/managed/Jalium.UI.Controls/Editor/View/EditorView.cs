...
internal sealed class EditorView
{
    ...
    private Brush GetFallbackBrushForClassification(TokenClassification classification, Brush defaultBrush)
    {
        ...
        return classification switch
        {
            ...
            TokenClassification.StructName => s_typeNameBrush,
            TokenClassification.EnumName => s_typeNameBrush,
            TokenClassification.InterfaceName => s_typeNameBrush,
            TokenClassification.DelegateName => s_typeNameBrush,
            ...
            TokenClassification.EnumMember => s_propertyBrush,
